...
namespace APIEcommerce.Controllers.V2
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        // [EnableCors(PolicyNames.AllowSpecificOrigin)]
        public ActionResult<IEnumerable<CategoryDto>> GetCategoriesOrderById()
        {
            ICollection<Category> categories = _categoryRepository.GetCategories().OrderBy(category => category.Id).ToList();
